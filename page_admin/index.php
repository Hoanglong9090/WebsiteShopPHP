...
$ddh=mysqli_num_rows(mysqli_query($conn,"SELECT * FROM dondat WHERE TrangThai=0"));
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $ddh; ?></div>
                        ...
                        <div class="panel-body">
                            <div class="list-group">
                                ...
                                <a href="BinhLuan.php" class="list-group-item">
                                    <span class="badge"><?php echo 3 ?></span>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="list-group">
                                ...
                                <a href="DonDatHang.php" class="list-group-item">
                                    <span class="badge"><?php echo $ddh; ?></span>
